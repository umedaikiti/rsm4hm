function sos = my_sosconstr(sos,Type,symexpr,new_decvartable)
...
%        end
    ...
    [sos.expr.At{expr},sos.expr.b{expr},sos.expr.Z{expr}] = ...
        my_getequation(char(symexpr),sos.vartable,sos.decvartable,sos.varmat.vartable,new_decvartable);
else
...
%            end
        ...
        [sos.expr.At{expr},sos.expr.b{expr},sos.expr.Z{expr}] = ...
            my_getequation(symexpr,sos.vartable,sos.decvartable,sos.varmat.vartable,new_decvartable);
